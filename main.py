...
from index.static import write_q_path, write_d_path, write_q_norm_path, write_d_norm_path
...
if __name__ == "__main__":
    ...
    #
    # build_q(read_path=Wiki.file_path_list[5], write_path=write_q_path, page_limit=10)
    #
