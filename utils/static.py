...
Dataset = namedtuple('Dataset', 'name url download_path unpack_dir_path file_path')
...
WikiParagrahs = Dataset(
    ...
    file_path=[os.path.join(file_folder_path, 'paragraphCorpus', 'dedup.articles-paragraphs.cbor')],
)
...
Wiki = Dataset(
    ...
    unpack_dir_path=file_folder_path,
    file_path=[os.path.join(file_folder_path, 'paragraphCorpus', 'fold-4-unprocessedAllButBenchmark.Y2.cbor'),
